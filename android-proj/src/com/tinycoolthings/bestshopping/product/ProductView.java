...
public class ProductView extends SherlockFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            currProd = BestShopping.getInstance().getProductById(getIntent().getExtras().getInt(Constants.Extras.PRODUCT));
            BestShopping.getInstance().refreshProduct(currProd);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_icon_save_in_list:
                BestShopping.getInstance().updateProduct(currProd);
                BestShopping.getInstance().refreshProduct(currProd);
