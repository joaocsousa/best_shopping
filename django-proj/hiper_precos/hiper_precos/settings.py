...
MEDIA_ROOT = '/home/tinycool/website/media'
...
SECRET_KEY = '@jsk2bmbdu&&3o^j$rbx%ut*_rt*%pau&2=v*=0o5%m^zmqq+!'
...
INTERNAL_IPS = ('127.0.0.1','129.121.177.5','tinycoolthings.com')
...
ROOT_URLCONF = 'hiper_precos.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'hiper_precos.wsgi.application'
